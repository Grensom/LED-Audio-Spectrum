...
void loop() {
  ...
  if (y < 100) {
    ...
    while (y > 1000) {
      ...
      FastLED.show();
      delay(60);
      fill_solid( leds, num_leds, leds[30]);
      a = a + 1;
      if (a > 1023){
        a = 0;
      }
